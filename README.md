...
beyond the first, and SSO are the paid features: a **team** license (up to ten seats, 25 € per seat per month or 20 € on an annual plan,
bought on the site by card) or an **enterprise** one (any size, by contact) — or, to try
