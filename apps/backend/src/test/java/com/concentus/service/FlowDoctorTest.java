...
class FlowDoctorTest {
    ...
    private final FlowDoctor doctor = doctorWith(new ContextFolderResolver(""));
    ...
    private FlowDoctor doctorWith(ContextFolderResolver contextRoots) {
        return new FlowDoctor(claude, new FlowCompiler(), credentials, mcpOAuth, plugins, runtimes,
                runStore, variables, new OrgContext("default"), facades, contextRoots);
    }
