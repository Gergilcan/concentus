 ...
 * is the seam: the decision is asked here, so moving it to a stored per-organization list changes
 * this file and nothing else. Today the provider sign-in asks it; the password paths do not.
 */
@Component
